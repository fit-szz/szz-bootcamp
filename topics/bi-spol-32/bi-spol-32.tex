...
Nadále se ale budeme spíše zabývat lineárními rekurentními rovnicemi řádu $k \in N$:

\begin{center}
    $c_ka_{n+k} + c_{k-1}(n) a_{n+k-1} + · · · + c_1(n) a_{n+1} + c_0(n) a_n = b_n$ pro každé $n \geq n_0$,
\end{center}
