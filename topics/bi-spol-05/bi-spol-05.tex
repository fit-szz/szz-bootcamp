...
Prvky jsou ukládány na další následující místo v poli získané za pomoci dvojité hašovací funkce. V případě mazání prvku se zamění za
značku smazaného prvku, který značí možnou existenci dalších prvků s ekvivalentním hašem.
