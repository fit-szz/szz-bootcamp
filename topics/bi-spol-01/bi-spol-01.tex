...
\newline
\newline
Na rozdíl od NTS si může vybrat jak pokračovat dál.
...
\newline
\newline
DTS \textbf{přijme} řetězec pokud přejde do koncového stavu a páska je po skončení vyplněná prázdnýmy symboly BLANK.
\newline
